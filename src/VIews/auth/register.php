...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="container mx-auto mt-10">
        ...
        <!-- Registration Form -->
        <form action="/register" method="post" class="bg-white p-6 rounded shadow-md ajax-form" data-redirect-to="/login">
            <input type="hidden" name="csrf_token" value="<?= csrf_token(); ?>">
            
            <!-- Username Field -->
            <div class="mb-4">
                <label for="username" class="block text-gray-700">Username:</label>
                <input type="text" id="username" name="username" value="" required class="w-full p-2 border border-gray-300 rounded">
            </div>
